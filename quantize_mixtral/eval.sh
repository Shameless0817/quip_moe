...
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m eval.eval_ppl  --hf_path /fact_data/zeyuli/mixtral_8x7b_quip_full_noft --seqlen 4096

# CUDA_VISIBLE_DEVICES=0,1,2,3 python -m eval.eval_ppl  --hf_path /fact_home/zeyuli/quip_sharp/mixtral_lora_converted_hf_v2 --seqlen 4096