...
parser.add_argument('--hf_path', default='/fact_data/zeyuli/mixtral_8x7b_quip_full_noft', type=str)
...
parser.add_argument('--use_lora', action='store_true')  # 添加新的参数
...
def main(args):
    ...
    if not args.use_lora:
        ...
        # model, model_str = lora_model_from_hf_path(
        #     args.hf_path,
        #     use_cuda_graph=not args.no_use_cuda_graph,
        #     use_flash_attn=not args.no_use_flash_attn)
        model, model_str = lora_model_from_hf_path(
